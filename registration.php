...
if (isset($_POST['submit'])) {
    if (
        ...
        $check_username = mysqli_query($db, "SELECT username FROM user_tbl where username = '" . $_POST['username'] . "' ");
        $check_email = mysqli_query($db, "SELECT email FROM user_tbl where email = '" . $_POST['email'] . "' ");
        ...
        if ($_POST['password'] != $_POST['cpassword']) {
            ...
            $mql = "INSERT INTO user_tbl(username,first_name,last_name,email,phone,password,address) 
            VALUES('" . $_POST['username'] . "','" . $_POST['firstname'] . "','" . $_POST['lastname'] . "','" . $_POST['email'] . "','" . $_POST['phone'] . "','" . sha1($_POST['password']) . "','" . $_POST['address'] . "')";
            mysqli_query($db, $mql);
...
<body>
    <section class="signup-section" style="background-image: url('tilt.svg');">
        <div class="signup-form-container">
            ...
            <div class="form">
                ...
                <div class="sign-up-qoute">
                    <h2>Sign Up</h2>
                    <p>create your account to explore and order</p>
                </div>
                ...
                <form action="" method="post" class="form-inputs">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="phone" id="example-tel-input-3" placeholder="Phone Number">
                        </div>
                        <div class="form-group">
                ...
                <div class="cta">Already have an Account?<a href="login.php" style="color:#5c4ac7; white-space: nowrap;"> Login</a></div>
            </div>
        </div>
    </section>
    </div>
